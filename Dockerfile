...
RUN apt-get update && apt-get install -y --no-install-recommends git pkg-config libssl-dev libfuse-dev libgit2-dev protobuf-compiler && rm -rf /var/lib/apt/lists/*
